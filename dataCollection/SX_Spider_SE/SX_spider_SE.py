"""
    This Scraper was with the help of an government official;
    Thanks a lot to @frederichchen;
...
class SXSpider:
    def __init__(self):
        ...
        """
        self.driver = webdriver.Chrome()  # here you need to insert your Chrome webdriver adrress
